...
const Internships = ({ setActiveItem }) => {
  ...
  const handleNewInternship = () => {
    alert('New internship created!');
  };

  const handleEdit = (id) => {
    alert(`Editing internship ${id}`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button onClick={handleNewInternship} className="bg-[#0EA5A4] text-white px-4 py-2 rounded-lg hover:bg-[#06B6D4] flex items-center gap-2">
          ...
          <div key={job.id} className="bg-white rounded-xl shadow p-5 hover:shadow-lg transition">
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2">
                <button onClick={() => handleEdit(job.id)} className="p-2 rounded hover:bg-gray-100">
                  <Edit className="w-4 h-4 text-[#0EA5A4]" />
                </button>
                <button onClick={() => handleDelete(job.id)} className="p-2 rounded hover:bg-gray-100">
