...
import Reports from '../components/industry/Reports';
import Partnerships from '../components/industry/Partnerships';
import { Briefcase, Bell, Users, Award, BarChart2, GitPullRequest, LogOut, Plus, Check, FileText } from 'lucide-react';
...
const Industry = () => {
  ...
  return (
    <div className="bg-[#FAFBFC] min-h-screen font-sans flex">
        <IndustrySidebar activeItem={activeItem} setActiveItem={setActiveItem} />
        <div className="flex-1 flex flex-col">
            <header className="bg-white shadow-sm w-full">
                <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    <div className="flex items-center space-x-4">
                    <h1 className="text-2xl font-bold text-[#0F172A]">{activeItem.charAt(0).toUpperCase() + activeItem.slice(1)}</h1>
                    </div>
            ...
            <main className="flex-1 max-w-full mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 overflow-y-auto">
                {renderContent()}
            </main>
        </div>
    </div>
